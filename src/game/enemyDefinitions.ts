...
const acidSlimeUrl = new URL('../assets/enemies/acid_slime.png', import.meta.url).href;
...
export const ENEMY_BY_ID: Record<EnemyTypeId, EnemyDefinition> = ENEMY_DEFINITIONS.reduce(
  (acc, enemy) => {
    acc[enemy.id] = enemy;
    return acc;
  },
